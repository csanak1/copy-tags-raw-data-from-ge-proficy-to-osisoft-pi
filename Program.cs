...
namespace CopyTagsRawDataFromGEProficyToOsisoftPI
{
    class Program
    {
        ...
        private static void Start()
        {
            ...
            string[] tagNames = { "BC.TDI1.FIC3401.PV", "BC.TDI1.FIC3401.MODE", "BC.HCLCONV.FIC1020.MODE", "BC.TDI1.P3774BFUT.PV", "BC.TDI2.UP6901A.PV", "BC.HCLCONV.XV1700B.PV" };

            var startDate = new DateTime(2021, 01, 01, 00, 00, 00); // give a correct start date
            ...
            foreach (string tagName in tagNames)
            {
                ...
                if (dataToImport.Count > 0)
                {
                    ...
                    //bool result = pida.InsertTagValues(piTag, Extensions.ConvertToDataTable(dataToImport), false); //for TEST Tags, MUST BE added manually
